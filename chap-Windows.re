...
- Esc	現在の作業を停止または終了する。
 ...
 最近のキーボードにはWindowsロゴキー無効化機能が搭載されていることが多く、邪魔者扱いされることが多いキーですが、多くのショートカットがあります。
...
Windows10のショートカットを紹介しました。よく使うであろうショートカットを覚えた後、自分が使うであろうショートカットを追加で覚えていくと良いでしょう。ショートカットで快適な操作ができることを願っております。